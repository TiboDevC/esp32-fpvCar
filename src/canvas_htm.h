...
static const char canvas_htm[] PROGMEM = "<!--This code is based on a project by Seb Lee-Delisle: http://seb.ly/2011/04/multi-touch-game-controller-in-javascripthtml5-for-ipad/-->\n"
                                         ...
                                         "        const maxHeight = window.innerHeight - document.getElementById('navTop').offsetHeight - document.getElementById('navBottom').offsetHeight;\n"
                                         "        if (window.innerWidth * aspectRatio <= maxHeight) {\n"
                                         "            document.getElementById('imgStream').style.height = window.innerWidth * aspectRatio + \"px\";\n"
                                         "            document.getElementById('imgStream').style.width = window.innerWidth + \"px\";\n"
                                         "        } else {\n"
                                         "            document.getElementById('imgStream').style.height = maxHeight + \"px\";\n"
                                         "            document.getElementById('imgStream').style.width = maxHeight / aspectRatio + \"px\";\n"
                                         "        }\n"
                                         "    }\n"
                                         "\n"
                                         "    /*\n"
                                         ...
                                         "    <img alt=\"\" height=\"160\" id=\"imgStream\" src=\"\" >\n"
                                         "</div>\n"
                                         "\n"
